...
public class MultiChatController {
    ...
    public MultiChatController(String chatLogin, String password) {
        this.chatLogin = chatLogin;
        this.password = password;
    }

    public void startChat(Context ctx,QBUser user) {
        
    	InitiStaticCode.initStaticCode(ctx);
    	this.me = user;
    	chatThread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                config = new ConnectionConfiguration(QBChat.getChatServerDomain());
                ...
                try {
                    ...
                    *///Log.d("friendLogin ->",friendLogin);
                    ...
                    /*try{
                            ...
                            sendMessage(profileId+"###<"+me.getFullName()==null||me.getFullName().trim().length()<=0?me.getLogin():me.getFullName()+"> has joined the chatroom");
...
*/
                	...
                	Log.i("AFRIN","XMPPException");
                    e.printStackTrace();
                } catch(Exception e){
                	Log.i("AFRIN","Regular Exception");
                    e.printStackTrace();
                }
        ...
        if(null != muc){
            ...
            muc.addMessageListener(new PacketListener() {
                ...
                public void processPacket(Packet packet) {
                    Log.i("AFRIN", "receiving message"+packet.getFrom()+" "+((Message)packet).getBody());
