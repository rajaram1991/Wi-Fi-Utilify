...
public class OnlineStreamerActivity extends Activity {

		private ImageButton streamButton;
		private ImageButton billyButton;
		private ImageButton breakingButton;
		private ImageButton daftButton;
		private ImageButton beatlesButton;
		private ImageButton ccrButton;
	    ...
	    private void initControls() {
			...
			streamButton = (ImageButton) findViewById(R.id.button_queen);
			streamButton.setOnClickListener(new View.OnClickListener() {
				public void onClick(View view) {
					startStreamingAudio();
	        }});
			//testing
			billyButton = (ImageButton) findViewById(R.id.button_billy);
			billyButton.setOnClickListener(new View.OnClickListener() {
				public void onClick(View view) {
					startStreamingAudio2();
	        }});
			breakingButton = (ImageButton) findViewById(R.id.buttonBreakingBen);
			breakingButton.setOnClickListener(new View.OnClickListener() {
				public void onClick(View view) {
					startStreamingAudio3();
	        }});
			daftButton = (ImageButton) findViewById(R.id.buttonDaftPunk);
			daftButton.setOnClickListener(new View.OnClickListener() {
				public void onClick(View view) {
					startStreamingAudio4();
	        }});
			beatlesButton = (ImageButton) findViewById(R.id.buttonBeatles);
			beatlesButton.setOnClickListener(new View.OnClickListener() {
				public void onClick(View view) {
					startStreamingAudio5();
	        }});
			ccrButton = (ImageButton) findViewById(R.id.buttonCCR);
			ccrButton.setOnClickListener(new View.OnClickListener() {
				public void onClick(View view) {
					startStreamingAudio6();
	        }});
			//end testing
	    ...
	    private void startStreamingAudio2() {
	    	try { 
	    		final ProgressBar progressBar = (ProgressBar) findViewById(R.id.progress_bar);
	    		if ( audioStreamer != null) {
	    			audioStreamer.interrupt();
	    		}
	    		audioStreamer = new StreamingMediaPlayer(this,textStreamed, playButton, billyButton,progressBar);
	    		audioStreamer.startStreaming("http://www.nibinabraham.com/songs/Piano_Man.mp3",2340, 149);
	    	} catch (IOException e) {
		    	Log.e(getClass().getName(), "Error starting to stream audio.", e);            		
	    	}
	    	    	
	    }
	    private void startStreamingAudio3() {
	    	try { 
	    		final ProgressBar progressBar = (ProgressBar) findViewById(R.id.progress_bar);
	    		if ( audioStreamer != null) {
	    			audioStreamer.interrupt();
	    		}
	    		audioStreamer = new StreamingMediaPlayer(this,textStreamed, playButton, breakingButton,progressBar);
	    		audioStreamer.startStreaming("https://www.wingsofblack.net/data/music/Breaking%20Benjamin/Dear%20Agony/Dear%20Agony.mp3",2340, 149);
	    	} catch (IOException e) {
		    	Log.e(getClass().getName(), "Error starting to stream audio.", e);            		
	    	}
	    	    	
	    }
	    private void startStreamingAudio4() {
	    	try { 
	    		final ProgressBar progressBar = (ProgressBar) findViewById(R.id.progress_bar);
	    		if ( audioStreamer != null) {
	    			audioStreamer.interrupt();
	    		}
	    		audioStreamer = new StreamingMediaPlayer(this,textStreamed, playButton, daftButton,progressBar);
	    		audioStreamer.startStreaming("http://www.hivenet.is/hive.is/mp/Daft%20Punk%20-%20Alive%202007/05-Daft%20Punk%20-%20Around%20The%20World%20-%20Harder,%20Better,%20Faster,%20Stronger.mp3",2340, 149);
	    	} catch (IOException e) {
		    	Log.e(getClass().getName(), "Error starting to stream audio.", e);            		
	    	}
	    	    	
	    }
	    private void startStreamingAudio5() {
	    	try { 
	    		final ProgressBar progressBar = (ProgressBar) findViewById(R.id.progress_bar);
	    		if ( audioStreamer != null) {
	    			audioStreamer.interrupt();
	    		}
	    		audioStreamer = new StreamingMediaPlayer(this,textStreamed, playButton, beatlesButton,progressBar);
	    		audioStreamer.startStreaming("http://tylergrund.com/mp3/Beatles/Yesterday.mp3",2340, 149);
	    	} catch (IOException e) {
		    	Log.e(getClass().getName(), "Error starting to stream audio.", e);            		
	    	}
	    	    	
	    }
	    private void startStreamingAudio6() {
	    	try { 
	    		final ProgressBar progressBar = (ProgressBar) findViewById(R.id.progress_bar);
	    		if ( audioStreamer != null) {
	    			audioStreamer.interrupt();
	    		}
	    		audioStreamer = new StreamingMediaPlayer(this,textStreamed, playButton, ccrButton,progressBar);
	    		audioStreamer.startStreaming("http://www.ghostwhisperer.us/Music/Credence%20Clearwater%20Revival/Born%20On%20The%20Bayou.mp3",2340, 149);
	    	} catch (IOException e) {
		    	Log.e(getClass().getName(), "Error starting to stream audio.", e);            		
	    	}
	...
	private class StreamingMediaPlayer {
		...
		private int counter = 0;
	 	...
	 	public StreamingMediaPlayer(Context  context,TextView textStreamed, ImageButton	playButton, ImageButton	streamButton,ProgressBar	progressBar) 
	 	{
